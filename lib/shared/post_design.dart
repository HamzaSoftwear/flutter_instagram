...
import 'package:flutter_instagram/screens/comments.dart';
import 'package:flutter_instagram/shared/colors.dart';
import 'package:flutter_instagram/shared/heart_animation.dart';
      ...
      child: Column(
        children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      widget.data["username"] ?? "Unknown User",
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    LikeAnimation(
                      isAnimating: (widget.data['likes'] ?? []).contains(FirebaseAuth.instance.currentUser!.uid),
                      smallLike: true,
                      child: IconButton(
                        onPressed: () async {
          ...
          Container(
              ...
              child: Text(
                DateFormat('MMMM d, ' 'y')
                    .format(widget.data["datePublished"] ?? DateTime.now()),
                style: TextStyle(
                    fontSize: 18, color: Color.fromARGB(214, 157, 157, 165)),
                textAlign: TextAlign.start,
              )),
